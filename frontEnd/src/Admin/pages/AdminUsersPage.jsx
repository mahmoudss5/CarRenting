...
export default function AdminUsersPage() {
  ...
  const SUMMARY = [
    ...
    },
    {
      ...
      gradient: "linear-gradient(135deg,#e11d48,#f87171)",
      icon: UserX,
    },
  ];
  ...
  const counts = TABS.reduce((acc, t) => {
    acc[t] =
      t === "all" ? users.length : users.filter((u) => u.status === t).length;
    return acc;
  }, {});
  ...
  return (
    <AdminLayout>
      <motion.div variants={stagger} initial="hidden" animate="show">
        ...
        <motion.div
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/65 text-sm">
              Manage all registered users, approve owners, and moderate
              accounts.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={fadeUp}
          className="bg-white rounded-2xl shadow-ambient border border-surface-dim overflow-hidden">
              ...
              <thead>
                <tr className="border-b border-surface-dim">
                  {[
                    ...
                    <th
                      key={col}
                      className="px-6 py-3 text-left font-body text-label-sm uppercase tracking-[0.05em] text-on-surface/40 font-semibold">
                      {col}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {filtered.map((u, i) => (
                  <motion.tr
                    ...
                    <td className="px-6 py-4 font-body text-body-md text-on-surface/55">
                      {u.email}
                    </td>
                    <td className="px-6 py-4">
