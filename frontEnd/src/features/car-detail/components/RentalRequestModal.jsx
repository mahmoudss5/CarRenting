        ...
        {file ? (
          ...
          <>
            <Upload
              ...
              strokeWidth={1.8}
            />
            <span className="font-inter text-xs text-on-surface/40">
              Click to upload
            </span>
          </>
        )}
    ...
    <div className="flex flex-col items-center justify-center text-center gap-3 py-6 px-2">
      ...
      <div>
        ...
        <p className="font-inter text-xs text-on-surface/50 mt-1 leading-relaxed">
          Your driver's license has already been submitted. You're ready to
          book!
        </p>
      </div>
    </div>
    ...
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="font-inter text-xs text-on-surface/40 leading-relaxed">
          Submit your license details and upload both sides so the owner can
    ...
    <div className="flex flex-col items-center text-center px-8 py-10">
      ...
      <motion.div
        ...
        <p className="font-inter text-body-md text-on-surface/55 max-w-xs mx-auto leading-relaxed">
          Your rental request for the{" "}
          <strong className="text-on-surface">{car.name}</strong> has been sent
...
function UnavailableDatesCalendar({ dates }) {
  ...
  return (
    <div className="mt-4 p-4 bg-red-50/50 rounded-xl border border-red-100">
      <p className="font-inter text-sm font-semibold text-red-700 mb-3">
        Unavailable dates for the next 3 months:
      </p>
          ...
          .map(([key, days]) => {
            ...
            return (
              <div
                ...
                <span className="font-inter text-xs font-bold text-red-600">
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {days
                    ...
                    .map((day) => (
                      <span
                        key={day}
                        className="inline-flex items-center justify-center w-6 h-6 rounded bg-red-100 text-red-700 text-xs font-semibold">
                        {day}
                      </span>
                    ))}
                </div>
                      ...
                      <div className="flex flex-col mt-1">
                        {[
                          ...
                          <div
                            ...
                            <span className="font-inter text-sm text-on-surface/55">
                              {label}
                            </span>
                            <span className="font-inter text-sm font-semibold text-on-surface/75">
                              {value}
                            </span>
                          </div>
                        ))}
                        <div className="flex items-center justify-between pt-3 mt-1 border-t border-outline-variant/20">
                          <span className="font-inter text-sm font-bold text-on-surface">
                            Total Amount
                          </span>
                  ...
                  <div className="px-7 pb-7">
                    {submitError && (
                      <div className="mb-3 flex items-start gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3">
                        ...
                        <p className="font-inter text-sm text-red-700 leading-snug">
                          {submitError}
                        </p>
                      </div>
                    )}
                    {unavailableDates.length > 0 && (
                      <UnavailableDatesCalendar dates={unavailableDates} />
                    )}
                    <button
                      type="button"
                      onClick={onConfirm}
