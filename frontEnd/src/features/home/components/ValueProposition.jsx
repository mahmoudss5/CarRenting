      ...
      <div className="max-w-7xl mx-auto px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            ...
            <PrimaryButton onClick={handleRentCar}>Rent a Car</PrimaryButton>
          </div>
          ...
          <div
            ...
            style={{
              background: "linear-gradient(155deg, #003d9b 0%, #0052cc 100%)",
            }}>
            ...
            <ul className="flex flex-col gap-3 mb-8">
              {OWNER_BENEFITS.map((b) => (
                <li key={b} className="flex items-center gap-3">
                  ...
                  <span className="font-inter text-body-md text-white/80">
                    {b}
                  </span>
                </li>
              ))}
            </ul>
            <button className="px-6 py-3 rounded-md font-semibold text-primary bg-white hover:bg-white/90 transition-all duration-200 text-[0.9375rem]">
              Become a Car Owner
            </button>
          </div>
        </div>
