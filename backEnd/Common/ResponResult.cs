...
public class ResponResult<T>
{
    ...
    public static ResponResult<T> Fail(string error, int statusCode = 400, object? extraData = null) =>
        new() { Success = false, Error = error, StatusCode = statusCode, ExtraData = extraData };
